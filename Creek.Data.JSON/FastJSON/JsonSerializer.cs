...
namespace Creek.Data.JSON.FastJSON
{
    internal sealed class JSONSerializer
    {
        ...
        private void WriteEnum(System.Enum e)
        {
        ...
        void WriteDataTable(DataTable dt)
        {
           _output.Append('{');
            if (_params.UseExtensions)
            {
               WritePair("$schema", _params.UseOptimizedDatasetSchema ? (object)this.GetSchema(dt) :GetXmlSchema(dt));
               _output.Append(',');
            }
