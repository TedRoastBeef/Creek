...
namespace Creek.MVP.Configuration.Tasks
{
    #region Documentation
    /// <summary>
    /// Attribute to describe a task structure. Allows describing a task's structure
    /// with XML (see the example below) and/or specifying a <see cref="MVCConfiguration.TaskInfoProviderType"/>
    /// type to be used by this task.
    /// <para>If you want to describe a task's structure with an XML string then the
    /// <see cref="TaskInfoByXmlAMVCConfigurationtion.TaskInfoProviderType</see>
    /// property should point to <see cref="Navigator"/> or
