...
namespace Creek.MVP.Configuration.Views
{
    ...
    /// within the <see cref="TaskInfo.ViewInfos">TaskInfo.ViewInfos</see> property.
    /// After a task is started the corresponding <see cref="IViewsManager"/> is linked
    /// to this ViewInfoCollection object via its <see cref="IViewsManager.ViewInfos">
    /// IViewsManager.ViewInfos</see> property.</remarks>
    /// <seealso cref="IViewsManager.ViewInfos"/>
