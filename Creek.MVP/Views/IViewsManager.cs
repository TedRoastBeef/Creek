...
namespace Creek.MVP.Views
{
    ...
    /// </remarks>
    /// <seealso cref="WebformsViewsManager"/>
    /// <seealso cref="WinformsViewsManager"/>
    #endregion
    public interface IViewsManager
    {
        ...
        /// taken from the <see cref="TaskInfo.ViewInfos">
        ...
        #region Documentation
        /// <summary>
        /// Colection of <see cref="TaskInfo.ViewInfos"/> objects describing the views within
        /// the task.
