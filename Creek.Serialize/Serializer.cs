...
using System.Xml;
using Creek.Serialize.Advanced;
using Creek.Serialize.Advanced.Binary;
using Creek.Serialize.Advanced.Deserializing;
using Creek.Serialize.Advanced.Serializing;
using Creek.Serialize.Advanced.Xml;
using Creek.Serialize.Core;
using Creek.Serialize.Deserializing;
using Creek.Serialize.Serializing;
...
namespace Creek.Serialize
{
    ...
    public sealed class Serializer
    {
        ...
        public Serializer(SharpSerializerXmlSettings settings)
        {
        ...
        /// </summary>
        /// <param name = "settings"></param>
        public Serializer(SharpSerializerBinarySettings settings)
        {
            if (settings == null) throw new ArgumentNullException("settings");
            initialize(settings);
        }
