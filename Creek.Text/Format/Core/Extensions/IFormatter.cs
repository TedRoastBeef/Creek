...
namespace Lib.Format.Core.Extensions
{
    ...
    public interface IFormatter
    {
        ...
        void EvaluateFormat(object current, Parsing.Format format, ref bool handled, IOutput output, FormatDetails formatDetails);
    }
}
