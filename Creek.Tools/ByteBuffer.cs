...
namespace Creek.Tools
{
    public sealed class ByteBuffer
    {
        ...
        public double ReadDouble()
        {
            ...
            CheckCanRead(8);
            double num = BitConverter.ToDouble(Buffer, Position);
            Position += 8;
            return num;
        }
        ...
        {
            CheckCanRead(4);
            int num = ((Buffer[Position] | (Buffer[Position + 1] << 8)) | (Buffer[Position + 2] << 0x10)) |
        ...
        public float ReadSingle()
        {
            ...
            CheckCanRead(4);
            float num = BitConverter.ToSingle(Buffer, Position);
            Position += 4;
            return num;
        }
    }
