...
namespace Creek.Tools
{
    ...
    public struct Number : IConvertible, IComparable<Number>, IEquatable<Number>, IComparable
    {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly",
            Justification = "Parameter name is enough meaningful in the current context")]
        ...
        {
            return ((IConvertible) model).ToBoolean(provider);
        }
        ...
        {
            return ((IConvertible) model).ToByte(provider);
        }
        ...
        {
            return ((IConvertible) model).ToChar(provider);
        }
        ...
        {
            return ((IConvertible) model).ToDateTime(provider);
        }
        ...
        {
            return ((IConvertible) model).ToDecimal(provider);
        }
        ...
        {
            return ((IConvertible) model).ToDouble(provider);
        }
        ...
        {
            return ((IConvertible) model).ToInt16(provider);
        }
        ...
        {
            return ((IConvertible) model).ToInt32(provider);
        }
        ...
        {
            return ((IConvertible) model).ToInt64(provider);
        }
        ...
        {
            return ((IConvertible) model).ToSByte(provider);
        }
        ...
        {
            return ((IConvertible) model).ToSingle(provider);
        }
        ...
        {
            return ((IConvertible) model).ToString(provider);
        }
        ...
        {
            return ((IConvertible) model).ToType(conversionType, provider);
        }
        ...
        {
            return ((IConvertible) model).ToUInt16(provider);
        }
        ...
        {
            return ((IConvertible) model).ToUInt32(provider);
        }
        ...
        {
            return ((IConvertible) model).ToUInt64(provider);
        }
        ...
        [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules",
            ...
            Justification = "Reviewed. Suppression is OK here. It's like the System.Decimal documentation.")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly",
            Justification = "Parameter name is enough meaningful in the current context")]
        ...
        [SuppressMessage("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider",
            Justification = "The constructor will handle the culture")]
        ...
        {
            return Convert.ToDecimal(model);
        }
        ...
        {
            return model.ToString(provider);
        }
        ...
        {
            return model.ToString(format, provider);
        }
    }
}