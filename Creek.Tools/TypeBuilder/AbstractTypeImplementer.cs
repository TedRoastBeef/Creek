	...
	public abstract class AbstractTypeImplementer<TAbstract>
	{
        ...
        static AbstractTypeImplementer()
        {
            if (!typeof(TAbstract).IsAbstract)
                throw new InvalidOperationException(typeof(TAbstract).FullName + " is not an abstract type.");
        }
		...
		private static readonly MethodInfo _implementProperty = typeof(AbstractTypeImplementer<TAbstract>).GetMethod("ImplementProperty", BindingFlags.NonPublic | BindingFlags.Instance);
        /// <summary>
		...
		private static readonly MethodInfo _implementEvent = typeof(AbstractTypeImplementer<TAbstract>).GetMethod("ImplementEvent", BindingFlags.NonPublic | BindingFlags.Instance);
        /// <summary>
