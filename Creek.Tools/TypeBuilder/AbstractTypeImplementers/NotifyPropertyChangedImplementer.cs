...
namespace Lib.Tools.TypeBuilder.AbstractTypeImplementers
{
    /// <summary>
		...
		AbstractTypeImplementer<TAbstract>
	{
        ...
        /// </summary>
		public NotifyPropertyChangedImplementer(Expression<Func<PropertyChangedEventHandler>> eventHandlerFieldExpression):
			base(typeof(INotifyPropertyChanged))
		{
