...
namespace Lib.Tools.TypeBuilder
{
	...
	public sealed class FluentExpression
	{
        ...
        /// </summary>
		public static FluentExpression Assign<T1, T2>(Expression<Func<T1>> left, Expression<Func<T2>> right)
		where
			T2: T1
		{
			if (left == null)
        ...
        /// </summary>
        public static FluentExpression StaticCall(MethodInfo method, params FluentExpression[] arguments)
        {
			if (method == null)
				throw new ArgumentNullException("method");
