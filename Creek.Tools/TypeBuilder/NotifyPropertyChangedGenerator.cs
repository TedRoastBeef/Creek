...
namespace Lib.Tools.TypeBuilder
{
    ...
    public static class NotifyPropertyChangedGenerator
    {
        ...
        internal static MethodInfo _smartEquals = typeof(NotifyPropertyChangedGenerator).GetMethod("_SmartEquals", BindingFlags.NonPublic | BindingFlags.Static);
    ...
    public sealed class NotifyPropertyChangedGenerator<TBase>
    {
        ...
        private static readonly Expression<Func<PropertyChangedEventHandler>> _defaultEventHandlerFieldExpression = () => _defaultEventHandler;
        ...
        /// and also let you tell where is the field that stores the PropertyChanged delegates.
        /// </summary>
        public NotifyPropertyChangedGenerator(FluentTypeBuilder<TBase> typeBuilder, Expression<Func<PropertyChangedEventHandler>> eventHandlerFieldExpression)
        {
            if (typeBuilder == null)
            ...
            else
            {
                ...
                typeBuilder.AddEventWithDefaultImplementation("PropertyChanged", _defaultEventHandlerFieldExpression, false);
            }
        }
        ...
        private static readonly MethodInfo _addProperty = typeof(NotifyPropertyChangedGenerator<TBase>).GetMethod("AddProperty", new Type[]{typeof(string), typeof(string[])});
        /// <summary>
        /// Adds a new property to the generated type.
        /// The property will have its own field. You can optionally
        /// tell which other properties should be notified as having
        ...
        public void AddProperty<T>(string name, params string[] otherPropertiesToNotify)
        {
            ...
            if (otherPropertiesToNotify != null && otherPropertiesToNotify.Length > 0)
            {
                ...
                foreach(string otherName in otherPropertiesToNotify)
                    if (otherName == null)
                        throw new ArgumentException("otherPropertiesToNotify has null values.", "otherPropertiesToNotify");
            }
            ...
            var methodPart = 
                property.
                    ...
                    Body.
                        Assign(() => eventHandler, _eventHandlerFieldExpression).
        ...
        /// property.
        /// </param>
        public void AddProperty<T>(string name, Expression<Func<T>> getValueExpression, Expression<Action> setValueExpression, Expression<Func<T>> valueExpression, params string[] otherPropertiesToNotify)
        {
            ...
            AddProperty<T>(name, getValueExpression, setAction, valueExpression, otherPropertiesToNotify);
        }
        ...
        /// property.
        /// </param>
        public void AddProperty<T>(string name, Expression<Func<T>> getValueExpression, FluentMethodBuilder setValueAction, Expression<Func<T>> valueExpression, params string[] otherPropertiesToNotify)
        {
            if (name == null)
                throw new ArgumentNullException("name");
