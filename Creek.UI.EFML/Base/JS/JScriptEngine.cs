...
namespace Creek.UI.EFML.Base.JS
{
    /// <summary>
    ...
    public class JScriptEngine : WindowsScriptEngine
    {
        ...
        private static readonly Dictionary<int, string> runtimeErrorMap = new Dictionary<int, string>
                                                                              {
                                                                                  ...
                                                                                  {
                                                                                      5034,
                                                                                      "Circular reference in Content argument not supported"
                                                                                  },
        ...
        private readonly Object global = new Object();
        ...
        public void Add<T>(params KeyValuePair<string, T>[] p)
        {
