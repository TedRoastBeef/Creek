...
namespace Creek.UI
{
    ...
    public partial class BetterDialog : Form
    {
            ...
            using (Graphics graphics = CreateGraphics())
            {
                ...
                if (string.IsNullOrEmpty(smallExplanation) == false)
                {
                    if (SystemFonts.MessageBoxFont.FontFamily.Name == "Segoe UI")
                    {
                        ...
                        smallSize = graphics.MeasureString(smallExplanation, Font, label2.Width);
                ...
                else
                {
                    ...
                    pictureBox1.Margin = new Padding(pictureBox1.Margin.Left, 0, pictureBox1.Margin.Right,
        ...
        public static DialogResult ShowDialog(string title, string largeHeading, string smallExplanation,
                                              string leftButton, string rightButton, Image iconSet)
        {
            using (var dialog = new BetterDialog(title, largeHeading, smallExplanation, leftButton,
                                                 rightButton, iconSet))
            {
