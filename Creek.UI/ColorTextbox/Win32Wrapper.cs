...
namespace Creek.UI.ColorTextbox
{
    ...
    {
        [MarshalAs(UnmanagedType.I4)] public int lfHeight = 0;
        [MarshalAs(UnmanagedType.I4)] public int lfWidth = 0;
        [MarshalAs(UnmanagedType.I4)] public int lfEscapement = 0;
        [MarshalAs(UnmanagedType.I4)] public int lfOrientation = 0;
        [MarshalAs(UnmanagedType.I4)] public int lfWeight = 0;
    ...
    public struct RECT
    {
        ...
        /*public override bool Equals(object obj) {
            if (obj is RECT) {
                RECT comp = (RECT)obj;
                if (comp.Left ==Left && comp.Top ==Top &&
                    comp.Right ==Right && comp.Bottom ==Bottom) return true;
            }
            return false;
        }
        */
