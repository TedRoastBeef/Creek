...
// ReSharper restore UnusedMember.Global
    {
        ...
        #region IExceptionReportView Members
        ...
        {
            TreeNode rootNode = CreateSysInfoTree();
        ...
        private void PopulateReportInfo(ExceptionReportInfo reportInfo)
        {
            ...
            txtExceptionMessageLarge.Text =
                ...
                !string.IsNullOrEmpty(reportInfo.CustomMessage)
                    ? reportInfo.CustomMessage
                    : reportInfo.Exceptions[0].Message;
            ...
            lblContactCompany.Text = string.Format("If this problem persists, please contact {0} support.",
        ...
        private TreeNode CreateSysInfoTree()
        {
            ...
            foreach (SysInfoResult sysInfoResult in _presenter.GetSysInfoResults())
            {
