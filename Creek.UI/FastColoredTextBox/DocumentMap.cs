...
namespace Creek.UI.FastColoredTextBox
{
    ...
    public class DocumentMap : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //draw visible rect
            Point p0 = target.PlaceToPoint(startPlace);
            Point p1 = target.PlaceToPoint(r.Start);
            Point p2 = target.PlaceToPoint(r.End);
            int y1 = p1.Y - p0.Y;
            int y2 = p2.Y + target.CharHeight - p0.Y;
        ...
        private void Scroll(Point point)
        {
            ...
            Place pp = target.PointToPlace(p0);
