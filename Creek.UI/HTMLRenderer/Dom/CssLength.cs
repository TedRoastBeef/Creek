...
namespace Creek.UI.HTMLRenderer.Dom
{
    ...
    internal sealed class CssLength
    {
        ...
        public CssLength ConvertEmToPoints(float emSize)
        {
            ...
            return
                new CssLength(string.Format("{0}pt",
                                            Convert.ToSingle(Number*emSize).ToString("0.0",
        ...
        public CssLength ConvertEmToPixels(float pixelFactor)
        {
            ...
            return
                new CssLength(string.Format("{0}px",
                                            Convert.ToSingle(Number*pixelFactor).ToString("0.0",
                                                                                          NumberFormatInfo.InvariantInfo)));
        }
