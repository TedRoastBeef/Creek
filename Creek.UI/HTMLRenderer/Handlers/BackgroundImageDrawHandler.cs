...
namespace Creek.UI.HTMLRenderer.Handlers
{
    ...
    internal static class BackgroundImageDrawHandler
    {
        ...
        /// </summary>
        private static void DrawRepeatX(IGraphics g, ImageLoadHandler imageLoadHandler, RectangleF rectangle,
        ...
        /// </summary>
        private static void DrawRepeat(IGraphics g, ImageLoadHandler imageLoadHandler, RectangleF rectangle,
                                       Rectangle srcRect, Rectangle destRect, Size imgSize)
        {
            while (destRect.X > rectangle.X)
                destRect.X -= imgSize.Width;
