...
namespace Creek.UI.HTMLRenderer.Parse
{
    ...
    internal static class HtmlParser
    {
        ...
        {
            CssBox root = CssBox.CreateBlock();
            CssBox curBox = root;
            ...
            if (endIdx < source.Length)
            {
                ...
                {
                    CssBox abox = CssBox.CreateBox(root);
                    abox.Text = endText;
                }
            }
        ...
        {
            SubString text = tagIdx > startIdx ? new SubString(source, startIdx, tagIdx - startIdx) : null;
            if (text != null)
            {
                CssBox abox = CssBox.CreateBox(curBox);
                abox.Text = text;
            }
        }
                                              ...
                                              out Dictionary<string, string> attributes)
        {
            ...
            while (startIdx < idx + length)
            {
                ...
                string key = source.Substring(startIdx, endIdx - startIdx);
