...
namespace Creek.UI.HTMLRenderer.Utils
{
    ...
    internal static class FontsUtils
    {
        ...
        /// </summary>
        private static readonly Dictionary<string, string> _fontsMapping =
            new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase);

        /// <summary>
        /// collection of all installed and added font families to check if font exists
        /// </summary>
        private static readonly Dictionary<string, FontFamily> _existingFontFamilies =
            new Dictionary<string, FontFamily>(StringComparer.InvariantCultureIgnoreCase);

        /// <summary>
        /// cache of all the font used not to create same font again and again
        /// </summary>
        private static readonly Dictionary<string, Dictionary<float, Dictionary<FontStyle, Font>>> _fontsCache =
            new Dictionary<string, Dictionary<float, Dictionary<FontStyle, Font>>>(
        ...
        private static Font TryGetFont(string family, float size, FontStyle style)
        {
            ...
            {
                Dictionary<float, Dictionary<FontStyle, Font>> a = _fontsCache[family];
                if (a.ContainsKey(size))
                {
                    Dictionary<FontStyle, Font> b = a[size];
