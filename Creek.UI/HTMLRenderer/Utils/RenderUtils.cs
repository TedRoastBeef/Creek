...
namespace Creek.UI.HTMLRenderer.Utils
{
    ...
    internal static class RenderUtils
    {
        ...
        {
            CssBox containingBlock = box.ContainingBlock;
            while (true)
            {
                if (containingBlock.Overflow == CssConstants.Hidden)
                {
                    RectangleF prevClip = g.GetClip();
                    RectangleF rect = box.ContainingBlock.ClientRectangle;
                ...
                {
                    CssBox cBlock = containingBlock.ContainingBlock;
